"""
Tests for fpgrowth_rule_mining.
...
from fpgrowth_rule_mining import Method, Settings, Weighting, mine
...
from fpgrowth_rule_mining.validation.significance import (
    _rule_columns,
    not_crowded,
    p_values_for,
    survives_shuffle,
)
from fpgrowth_rule_mining.transactions import (
    build_transactions,
    find_patches,
    measure_patches,
    strip_role,
)
from fpgrowth_rule_mining.tree import find_itemsets
...
def test_null_uses_the_same_transactions_the_run_mined():
    ...
    from fpgrowth_rule_mining.validation.significance import _adjacency
