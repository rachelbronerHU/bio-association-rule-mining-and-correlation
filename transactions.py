...
def build_transactions_from_neighborhoods(neighborhoods, cell_types, method):
    """
    Builds transactions from neighborhoods without filtering rare cell types.
    Rare cell filtering now happens post-mining to preserve spatial context.
    ...
    for item in neighborhoods:
        ...
        if method in ["CN", "KNN_R"]:
            ...
            # Build transaction with ALL cell types
